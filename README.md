...
## 🎯 Getting started
### 1. Choose one of the following methods to create a project from this template:
...
### 4. Set up Git hooks
Run this command to enable pre-commit checks:
...
Keep each pull request focused to make reviews faster and clearer.
